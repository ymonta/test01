...
<div id="windowArea">
  ...
  <div id="mainArea" class="typeB typeW">
    <div id="mainAreaHeadNav">
     <p>
      <mt:SetVar name="split" value=""/>
      <mt:Categories>
      <me:Var name="split"><a href="javascript:void(0)" onClick="jumpTo('#_<mt:CategoryBasename/>')"><mt:CategoryLabel/></a>
      <mt:SetVar name="split" value="<span>|</span>"/>
      </mt:Categories>
      </p>
     </div><!-- /mainAreaHeadNav -->
    ...
    <div class="main alp0" id="linkList">
      ...
      <mt:Categories>
      <div class="linkList" id="_<mt:CategoryBasename/>" name="_<mt:CategoryBasename/>">
        ...
        <mt:Entries>
         ...
         <li>
           ...
           <a href="<mt:EntryBody remove_html="1"/>" target="_blank" title="<mt:EntryTitle remove_html="1"/>">
             <span class="alp0"><mt:EntryTitle/></span>
           </a>
         </li>
